...
//                             <button
//                                 className="px-4 py-2 flex items-center rounded-md text-lg font-medium hover:bg-gray-700 focus:outline-none"
//                             >
//                                 Services
...
//                             {/* Dropdown Menu */}
//                             <div className="absolute z-10 mt-2 w-48 rounded-lg shadow-lg bg-gray-800 opacity-0 group-hover:opacity-100 transition-opacity duration-300 transform group-hover:translate-y-0 translate-y-2">
//                                 <Link
//                                     to="/web_development"
//                                     className="block px-4 py-2 text-sm text-white hover:bg-gray-700"
//                                 >
...
//                         >
//                             Services
//                             <FaChevronDown className={`ml-2 transition-transform duration-200 ${isMenuOpen ? 'rotate-180' : 'rotate-0'}`} />
//                         </button>
//                         {isMenuOpen && (
//                             <div className="pl-3 space-y-1">
//                                 <Link to="/web_development" onClick={() => setIsMenuOpen(false)} className="block pl-5 pr-3 py-2 text-base font-medium hover:bg-gray-700">Web Development</Link>
//                                 <Link to="/mobile_app" onClick={() => setIsMenuOpen(false)} className="block pl-5 pr-3 py-2 text-base font-medium hover:bg-gray-700">Mobile App</Link>
        ...
        <nav className="bg-gray-900 text-white sticky top-0 z-50">
            ...
            <div className={`md:hidden bg-gray-800 overflow-hidden transition-all duration-500 ease-in-out ${isMenuOpen ? 'max-h-screen' : 'max-h-0'}`}>
                <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                    ...
                    {/* Services Dropdown for Medium Screen */}
                    <div>
                        <button
