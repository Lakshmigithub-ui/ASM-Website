    ...
    return (
        <div className="relative bg-slate-50 text-gray-700 py-16 px-4 md:px-8">
            <div className="relative z-20">
                <Slider {...settings}>
                    {slides.map((slide, index) => (
                        <div key={index} className="relative flex flex-col lg:flex-row items-center justify-between p-4 md:p-8">
                            <div className="flex lg:flex-row flex-col">
                                <div className='m-9'>
                                    <h2 className="text-3xl md:text-3xl font-semibold mb-4" data-aos="fade-up" data-aos-delay={index * 300}>
                                        {slide.text.h2}
                                    </h2>
                                    <p className="text-base mb-4 font-medium" data-aos="fade-up" data-aos-delay={index * 400}>
                                        {slide.text.p}
                                    </p>
                                    <br />
                                    <button
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="mb-4">
                                ...
                                <input 
                                    ...
                                    className="w-full px-4 py-2 border border-gray-300 rounded bg-gray-100 focus:outline-none focus:border-blue-500"
            ...
            {isSubmitted && (
                <div className="fixed inset-0 flex justify-center items-center z-50">
                    <div className="bg-white rounded-lg shadow-lg p-8 max-w-md relative">
                        ...
                        <p className="text-gray-600">Thank you for enquiring. We will get back to you shortly.</p>
                    </div>
                </div>
            )}
        </div>
