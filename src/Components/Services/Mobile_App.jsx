    ...
    <div className="bg-gray-900 text-white min-h-screen p-8">
      ...
      <section className="mb-12">
        <div className="flex flex-col lg:flex-row items-center">
          ...
          <div className="lg:w-1/2 lg:pl-8" data-aos="fade-left">
            ...
            <p className="text-lg mb-4">Our iOS app development services focus on delivering high-performance apps that are compatible with the latest iOS versions and devices.</p>
            <p className="text-lg mb-4">We ensure a seamless user experience with robust features and exceptional UI/UX design tailored for the Apple ecosystem.</p>
          </div>
        </div>
      </section>
      ...
      <section className="mb-12">
        <div className="flex flex-col lg:flex-row items-center">
          ...
          <div className="lg:w-1/2 lg:pl-8" data-aos="fade-left">
            <h2 className="text-3xl font-semibold mb-4">Hybrid App Development</h2>
            <p className="text-lg mb-4">Our hybrid app development approach ensures you get a single codebase that runs smoothly on both iOS and Android platforms, saving time and costs.</p>
            <p className="text-lg mb-4">We leverage cross-platform frameworks to deliver high-quality apps with a native-like experience for users on any device.</p>
          </div>
        </div>
      </section>
