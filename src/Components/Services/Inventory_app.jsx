      ...
      <section className="py-16 px-4 md:px-8 bg-gray-800">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <ul className="list-disc text-left mx-auto max-w-sm space-y-4">
            <li className="text-gray-400 text-sm" data-aos="fade-up" data-aos-delay="300">Retail Stores</li>
            <li className="text-gray-400 text-sm" data-aos="fade-up" data-aos-delay="400">Warehouses</li>
            <li className="text-gray-400 text-sm" data-aos="fade-up" data-aos-delay="500">Manufacturers</li>
            <li className="text-gray-400 text-sm" data-aos="fade-up" data-aos-delay="600">E-commerce Businesses</li>
            <li className="text-gray-400 text-sm" data-aos="fade-up" data-aos-delay="700">Distributors</li>
            <li className="text-gray-400 text-sm" data-aos="fade-up" data-aos-delay="800">Logistics Companies</li>
          </ul>
        </div>
      </section>
    </div>
