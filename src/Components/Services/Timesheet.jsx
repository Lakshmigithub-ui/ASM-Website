      ...
      <section className="py-16 px-4 md:px-8 bg-gray-800">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex flex-col lg:flex-row justify-center gap-8">
            <div className="flex flex-col items-center bg-gray-800 rounded-lg p-6 shadow-lg" data-aos="fade-up" data-aos-delay="300">
            ...
            <div className="flex flex-col items-center bg-gray-800 rounded-lg p-6 shadow-lg" data-aos="fade-up" data-aos-delay="400">
              <div className="w-24 h-24 bg-blue-500 rounded-full flex items-center justify-center mb-4">
                <svg className="w-12 h-12 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="flex flex-col items-center bg-gray-800 rounded-lg p-6 shadow-lg" data-aos="fade-up" data-aos-delay="500">
              <div className="w-24 h-24 bg-blue-500 rounded-full flex items-center justify-center mb-4">
                <svg className="w-12 h-12 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
