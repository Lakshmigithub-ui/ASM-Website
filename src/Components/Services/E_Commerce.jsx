  ...
  return (
    <div className="bg-gray-900 text-gray-100 min-h-screen">
      ...
      <section className="relative bg-cover bg-center h-screen flex items-center justify-center text-center" style={{ backgroundImage: "url('https://example.com/ecommerce-background.jpg')" }}>
        ...
        <div className="relative z-10 flex flex-col items-center">
          <img src={e_commerce1} alt="E-commerce" className="w-full h-80 object-contain mb-6" data-aos="zoom-in" />
          <h1 className="text-lg md:text-lg font-extrabold text-white mb-4" data-aos="fade-up">Revolutionize Your Online Store</h1>
          <p className="text-sm md:text-sm text-gray-300 max-w-3xl mb-6" data-aos="fade-up" data-aos-delay="200">
            Empower your business with our next-gen e-commerce solutions, designed to bring modern shopping experiences to life.
          </p>
          <button className=" text-sm bg-customBlue hover:bg-blue-600 text-white px-8 py-4 rounded-full shadow-lg transition-transform transform hover:scale-105" data-aos="fade-up" data-aos-delay="400">Start Now</button>
        </div>
      </section>
        ...
        <div className="container mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="bg-gray-700 p-8 rounded-lg shadow-lg" data-aos="fade-up">
              ...
              <h3 className="text-lg font-semibold text-white mb-2">Stunning User Experience</h3>
      ...
      <section className="py-16 bg-gray-900 text-center">
        <div className="container mx-auto">
          <h2 className="text-lg font-bold mb-6 text-white" data-aos="fade-up">Ready to Start Your E-Commerce Journey?</h2>
          <p className="text-sm mb-8 text-gray-300" data-aos="fade-up" data-aos-delay="200">Contact us now to transform your business with a customized e-commerce app.</p>
          <button className=" text-sm bg-customBlue hover:bg-blue-600 text-white px-8 py-4 rounded-full shadow-lg transition-transform transform hover:scale-105" data-aos="fade-up" data-aos-delay="400">Contact Us</button>
        </div>
      </section>
    </div>
  );
