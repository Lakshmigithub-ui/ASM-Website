    ...
    <div className="bg-gray-900 text-white">
      ...
      <section className="py-20 px-4 md:px-8 bg-gray-800">
        <div className="max-w-6xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6" data-aos="fade-up">Welcome to MOI Soft</h1>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
            ...
            <div className="bg-gray-800 rounded-lg p-6 shadow-lg" data-aos="fade-up" data-aos-delay="200">
              <img src={moiSoftImage1} alt="Advanced Analytics" className="w-full h-48 object-cover rounded-t-lg mb-4" />
            ...
            <div className="bg-gray-800 rounded-lg p-6 shadow-lg" data-aos="fade-up" data-aos-delay="400">
              <img src={moiSoftImage2} alt="Customizable Dashboard" className="w-full h-48 object-cover rounded-t-lg mb-4" />
            ...
            <div className="bg-gray-800 rounded-lg p-6 shadow-lg" data-aos="fade-up" data-aos-delay="600">
              <img src={moiSoftImage3} alt="Seamless Integration" className="w-full h-48 object-cover rounded-t-lg mb-4" />
            ...
            <div className="bg-gray-800 rounded-lg p-6 shadow-lg" data-aos="fade-up" data-aos-delay="800">
              <img src={moiSoftImage4} alt="Mobile Accessibility" className="w-full h-48 object-cover rounded-t-lg mb-4" />
            ...
            <div className="bg-gray-800 rounded-lg p-6 shadow-lg" data-aos="fade-up" data-aos-delay="1000">
              <img src={moiSoftImage5} alt="Enhanced Security" className="w-full h-48 object-cover rounded-t-lg mb-4" />
      ...
      <section className="py-20 px-4 md:px-8 bg-gray-800">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6" data-aos="fade-up">Ready to Transform Your Business?</h2>
          <p className="text-lg md:text-xl mb-8" data-aos="fade-up" data-aos-delay="200">
