    ...
    <div className="bg-gray-900 text-gray-100 min-h-screen py-16">
      ...
      <section className="container mx-auto flex flex-col lg:flex-row items-center justify-between">
        ...
        <div className="lg:w-1/2 px-6" data-aos="fade-right">
          <h1 className="text-lg md:text-lg font-bold mb-6 text-white">Empower Your Business with Our CRM Solutions</h1>
          <p className="text-sm md:text-sm text-gray-300 leading-relaxed mb-6">
      ...
      <section className="py-16">
        <div className="container mx-auto text-center">
          <h2 className="text-lg font-bold mb-12 text-white" data-aos="fade-up">Why Choose Our CRM?</h2>
