...
const Testimonials = () => {
  ...
  return (
    <div className="bg-slate-100 text-gray-600 py-12 px-6 lg:px-16">
      <h2 className="text-xl font-bold mb-6 text-center" data-aos="fade-up">Testimonials of Our Happy Clients</h2>
      <Slider {...settings} className="text-center">
        <div className="p-6 bg-slate-200 rounded-lg shadow-lg" data-aos="fade-up" data-aos-delay="100">
        ...
        <div className="p-6 bg-slate-200 rounded-lg shadow-lg" data-aos="fade-up" data-aos-delay="200">
          <p className="text-xl font-semibold mb-2 transition-transform duration-500 transform hover:scale-105">
        ...
        <div className="p-6 bg-slate-200 rounded-lg shadow-lg" data-aos="fade-up" data-aos-delay="300">
          <p className="text-xl font-semibold mb-2 transition-transform duration-500 transform hover:scale-105">
        ...
        <div className="p-6 bg-slate-200 rounded-lg shadow-lg" data-aos="fade-up" data-aos-delay="400">
          <p className="text-xl font-semibold mb-2 transition-transform duration-500 transform hover:scale-105">
        ...
        <div className="p-6 bg-slate-200 rounded-lg shadow-lg" data-aos="fade-up" data-aos-delay="500">
          <p className="text-xl font-semibold mb-2 transition-transform duration-500 transform hover:scale-105">
        ...
        <div className="p-6 bg-slate-200 rounded-lg shadow-lg" data-aos="fade-up" data-aos-delay="600">
          <p className="text-xl font-semibold mb-2 transition-transform duration-500 transform hover:scale-105">
        ...
        <div className="p-6 bg-slate-200 rounded-lg shadow-lg" data-aos="fade-up" data-aos-delay="700">
          <p className="text-xl font-semibold mb-2 transition-transform duration-500 transform hover:scale-105">
